  ...
  <header id="masthead" class="site-header" role="banner">
    <h2 class="site-title">
      <router-link to="/" rel="home">
        <img alt="Theodo" src="/static/img/logo.png">
      </router-link>
    </h2>
